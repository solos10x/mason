...
<body>';
	...
	public function dashboardHead($css, $title, $desc, $keywords){
        ...
        <link href="'.URL.'css/themes/default.css" rel="stylesheet" type="text/css" id="style_color" />
		...
		$dashboardHeader .= '<!-- BEGIN LOGO -->
                    <div class="page-logo">
                        <a href="'.URL.'"> </a>
						<img src="'.URL.'/images/d_logo.png" alt="logo" class="logo-default" /> </a>
                ...
                <!-- BEGIN SIDEBAR TOGGLER BUTTON -->
						 ...
						 <li class="heading">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="'.URL.'dashboard/deposit" class="nav-link ">
                                            <span class="title">New Deposit</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="'.URL.'dashboard/deposit_history" class="nav-link ">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="'.URL.'dashboard/withdrawal" class="nav-link ">
                                            <span class="title">Make New Withdrawal</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="#" class="nav-link ">
                                            <span class="title">Withdrawal History</span>
                                        </a>
                                    </li>
								</ul>
							</li>
								...
								<li class="nav-item  ">
									<a href="'.URL.'dashboard/myreferrals" class="nav-link ">
	...
	'.$addScript.'
		...
		return $footer;
			...
			public function loginTakeNote() {
				$loginTakeNote = '
					<h3>Kindly Note</h3>
				<p align="justify">This document portal is provided on an “as is” and “as available” basis. Use of this website is at your own risk. We and our suppliers disclaim all warranties. Neither we nor our suppliers shall be liable for any damages of any kind with the use of this website. Using the portal requires the use of a password and a user name. Please take appropriate security measures to maintain the confidentiality of your password and username. Notify Mason Capital Investment immediately of any unauthorized use of your account or any other breach of security by contacting us at support@</p>';
