				...
				$output = '	
											<div class="admin-search-action-wrap"> 
												...
												<form action="" method="post">
													...
													<input type="text" name="amount" class="form-control" id="amount" placeholder="Amount to Deposit in Dollar"/>
													</div>
													
													<div class="form-group">
													<label>Select wallet to receive money</label>
													<select class="form-control form-select" name="type" id="type" > 
													<option >Select wallet to receive money</option>
													...
													<div class="form-group">
													<label>Address to receive money</label>
													<input type="text" name="amount" class="form-control" id="amount" placeholder="Address to receive money"/>
													</div>
													<div class="margiv-top-10">
													<button class="btn green btn-wrap green-btn btn-bordered btn-padded-sm" name="deposit">  Make Withdrawal  </button>
												</form>
											</div>
